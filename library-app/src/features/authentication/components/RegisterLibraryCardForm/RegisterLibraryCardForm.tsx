        ...
        <>
            {
                userState.loggedInUser ?
                    <div className="register-library-card-container">
                        ...
                        <p className="register-library-card-text">Your library card number is <strong>{userState.libraryCard}</strong></p> 
                        :
                    ...
                    <div className="register-library-card-container">
                        ...
                        <button className="register-library-modal-button" onClick={handleLoginClick}>Login</button> 
                    </div>
            }
        </>
    )
